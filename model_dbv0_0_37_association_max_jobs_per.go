...
type Dbv0037AssociationMaxJobsPer struct {
...
func NewDbv0037AssociationMaxJobsPer() *Dbv0037AssociationMaxJobsPer {
	this := Dbv0037AssociationMaxJobsPer{}
	return &this
}
...
func (o Dbv0037AssociationMaxJobsPer) MarshalJSON() ([]byte, error) {
...
type NullableDbv0037AssociationMaxJobsPer struct {
	value *Dbv0037AssociationMaxJobsPer
	isSet bool
}

func (v NullableDbv0037AssociationMaxJobsPer) Get() *Dbv0037AssociationMaxJobsPer {
	return v.value
}

func (v *NullableDbv0037AssociationMaxJobsPer) Set(val *Dbv0037AssociationMaxJobsPer) {
	v.value = val
	v.isSet = true
}

func (v NullableDbv0037AssociationMaxJobsPer) IsSet() bool {
	return v.isSet
}

func (v *NullableDbv0037AssociationMaxJobsPer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbv0037AssociationMaxJobsPer(val *Dbv0037AssociationMaxJobsPer) *NullableDbv0037AssociationMaxJobsPer {
	return &NullableDbv0037AssociationMaxJobsPer{value: val, isSet: true}
}

func (v NullableDbv0037AssociationMaxJobsPer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbv0037AssociationMaxJobsPer) UnmarshalJSON(src []byte) error {
	v.isSet = true
